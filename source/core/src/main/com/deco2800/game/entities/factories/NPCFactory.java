...
public class NPCFactory {
        ...
        public static Entity createPirateCrabEnemy(Entity target) {
                ...
                // Add combat stats, health bar and animal controller to the pirate crab entity
                pirateCrabEnemy
                ...
                PhysicsUtils.setScaledCollider(pirateCrabEnemy, 1f, 1f);
        ...
        public static Entity createMeleeBoss(Entity target) {
                ...
                boss.getComponent(EntityClassification.class)
                                .setEntityType(EntityClassification.NPCClassification.BOSS);
        ...
        /**
         * Creates a Ranged NPC to be used as an enemy. This uses different AI component
         * values
        ...
        public static Entity createSpecialNPC() {
                ...
                AnimationRenderComponent animator = new AnimationRenderComponent(
                                ServiceLocator.getResourceService().getAsset("images/npc_animations/npc.atlas",
                                                TextureAtlas.class));
