...
public class StructureFactory {
  ...
  private static String[] tower1Sprites = {"images/attack_towers/level1GuardianLeft.png", "images/attack_towers/level1GuardianRight.png"};
...
public static Entity createTrap(String name, Boolean isTemp) {
  ...
  public static Entity createTower1(int level, String name, Boolean isTemp) {
    ...
    String TOWER1I;
    if (isTemp) {
      TOWER1I = "images/attack_towers/level1GuardianLeft.png"; //change texture to be temp texture
    } else {
      TOWER1I = "images/attack_towers/level1GuardianLeft.png";
    }
    String TOWER1II = "images/attack_towers/level1GuardianLeft.png";
    String TOWER1III = "images/attack_towers/level1GuardianRight.png";
