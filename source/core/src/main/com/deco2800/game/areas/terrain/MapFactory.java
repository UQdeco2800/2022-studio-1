...
public class MapFactory {
  ...
  /**
   * Create a map factory with Orthogonal orientation
   *
   * @param cameraComponent Camera to render terrains to. Must be orthographic.
   */
  public MapFactory(CameraComponent cameraComponent) {
   ...
   */
  public MapFactory(CameraComponent cameraComponent, TerrainOrientation orientation) {
  ...
  /**
   * Create a map of the given type, using the orientation of the factory.
  ...
  public TerrainComponent createTerrain(TerrainType terrainType) {
    ...
    switch (terrainType) {
      case ATLANTIS_ISO:
        ...
        return createAtlantisTerrain(1f, isoGrass, isoWater, isoCliff, isoCliffLeft,
            isoCliffRight);
      default:
        return null;
    }
  ...
  private TerrainComponent createAtlantisTerrain(
    ...
    TiledMap tiledMap = createAtlantisTiles(tilePixelSize, grass, water, cliff, cliffLeft,
        cliffRight);
  ...
  private TiledMap createAtlantisTiles(
