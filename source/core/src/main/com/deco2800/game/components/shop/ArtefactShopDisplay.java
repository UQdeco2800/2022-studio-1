...
public class ArtefactShopDisplay extends UIComponent {
        ...
        private void changeRes() {
                ...
                itemDisplay.add(prevItem).width(Gdx.graphics.getWidth() * 0.058f)
                                .height(Gdx.graphics.getWidth() * 0.058f);
                itemDisplay.add(currentItem).width(Gdx.graphics.getWidth() * 0.087f)
                                .height(Gdx.graphics.getWidth() * 0.087f);
                itemDisplay.add(nextItem).width(Gdx.graphics.getWidth() * 0.058f)
                                .height(Gdx.graphics.getWidth() * 0.058f);
                ...
                itemDisplay.add(descriptionDisplay).colspan(3).center()
                                ...
                                .height(Gdx.graphics.getHeight() * 0.4f);
                ...
                buyButton.setPosition(Gdx.graphics.getWidth() / 2f + Gdx.graphics.getWidth() * 0.17f,
                                Gdx.graphics.getHeight() / 2f - Gdx.graphics.getHeight() * 0.22f);
                buyButton.setSize(Gdx.graphics.getWidth() * 0.175f, Gdx.graphics.getHeight() * 0.156f);

                priceDisplay.setPosition(Gdx.graphics.getWidth() / 2f - Gdx.graphics.getWidth() * 0.33f,
                                Gdx.graphics.getHeight() / 2f - Gdx.graphics.getHeight() * 0.22f);
