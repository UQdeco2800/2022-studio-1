...
class StructureFactoryTest {
    ...
    @BeforeEach
    void beforeEach() {
        when(FileLoader.readClass(StructureConfig.class, "configs/structure.json")).thenReturn(FileLoader.readClass(StructureConfig.class, "test/files/structure.json"));
    }
