...
public class AchievementHandlerTest {
    ...
    public void shouldCompleteStatAchievementMilestones() {
        ...
        new Achievement(100, AchievementType.GAME, true, false, "test", "test").setTotalAchieved(10);
    }

    @Test
    public void shouldCompleteStatAchievement() {
        Achievement test = new Achievement(100, AchievementType.GAME, true, false, "test", "test");
